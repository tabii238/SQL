...
INSERT INTO tbl_persons
	...
	VALUES
	('mark', 'smith', '232-345-5768'),
	('lauren', 'reed', '232-345-5768'),
	('rex', 'cook', '232-345-5768'),
	('lisa', 'haskell', '232-345-5768'),
	('sandra', 'wright', '232-345-5768')
;

SELECT persons_fname, persons_lname, persons_contact FROM tbl_persons WHERE persons_id BETWEEN 2 AND 5;
SELECT persons_fname, persons_lname, persons_contact FROM tbl_persons WHERE persons_lname LIKE 're%';
...
INSERT INTO tbl_species	
	...
	('chicken', 1, 100, 1, 5001, 2205, 'care_0'),
...
SELECT 
	...
	INNER JOIN tbl_order a4 ON a4.order_id = a1.species_habitat
